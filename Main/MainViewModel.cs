...
public partial class MainViewModel : ViewModelBase
{
	...
	private readonly Dictionary<string, object?> pageList = new Dictionary<string, object?>
	{
	...
	partial void OnSelectedPageChanged(NavigationViewItem value)
	{
		...
		CurrentPage = (pageList.ContainsKey(value.ToString()) ? pageList[value.ToString()] : pageList["Error"]);
	}
}